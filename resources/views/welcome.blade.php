...
@section('content')
    <section class="bg-white py-4 md:py-4">
        <div class="container flex items-center justify-between">
            <h2 class="text-2xl font-semibold">Buscar productos</h2>
            <form action="{{ route('welcome') }}" method="GET" class="flex items-center gap-2 w-full max-w-md ">
                ...
                <button
                    class="whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 inline-flex items-center justify-center rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-200 dark:focus:ring-gray-700 dark:focus:ring-offset-gray-950"
                    type="submit"
                >
                    Buscar
                </button>
            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p>stock <b>30</b></p>
                        <a href="{{ route('products.edit', $product->id) }}" class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-9 rounded-md px-3 btn btn-primary btn-sm">Editar</a>
                    </div>
                </div>
            </div>
        @empty
